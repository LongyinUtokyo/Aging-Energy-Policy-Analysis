...
ROOT = Path("/Users/longlab/Documents/New project")
DESKTOP = Path("/Users/longlab/Desktop/Aging Energy/Fig1")
DATA_CSV = ROOT / "outputs" / "overton_sdg_cleaned_merged.csv"
INDEX_V2_XLSX = ROOT / "ageing_energy_index_final_v2.xlsx"
OADR_CSV = DESKTOP / "unpopulation_人口元数据.csv"
WORLD_GEOJSON = ROOT / "outputs" / "world_countries.geojson"

OUTDIR = ROOT / "outputs" / "figures" / "figure1_quantitative"
OUTDIR.mkdir(parents=True, exist_ok=True)

WORKBOOK = ROOT / "figure1_quantitative_analysis.xlsx"
INTERP = ROOT / "figure1_quantitative_interpretation.txt"
